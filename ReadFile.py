    ...
    def readFile(self):
        ...
        for line in data:
            ...
            if (labelFlag):
                ...
                if "1" in segList[2]:
                    ans_tmp = self.qAnswersDic[qIndex][0]
                    label_tmp = self.qLabelsDic[qIndex][0]
                    self.qAnswersDic[qIndex][0] = segList[1]
                    self.qLabelsDic[qIndex][0] = segList[2]
                    self.qAnswersDic[qIndex][aIndex] = ans_tmp
                    self.qLabelsDic[qIndex][aIndex] = label_tmp
            aIndex += 1
